...
export default function InsightsPage() {
  ...
  useEffect(() => {
    ...
    const checkDefaults = async () => {
      try {
        ...
        console.log('No default insights found')
      }
    }
    checkDefaults()
  }, [])
  ...
  return (
    <main className="min-h-screen bg-white selection:bg-blue-100">
      <SiteHeader />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="space-y-2">
          <h1 className="text-3xl font-medium text-gray-900 tracking-tight">AI Research Insights</h1>
